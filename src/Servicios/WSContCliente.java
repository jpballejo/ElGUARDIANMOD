...
import ListServicios.ListImagenes;
...
//    
    ...
    ///////////////////////////////IMAGENES////////////////////////////////////// 
    @WebMethod
    public ListImagenes getFotosGaleria() {

        return new ListImagenes(fabricaElGuardian.getInstance().getInstanceIControladorCliente().getListaImagenesGaleria());
